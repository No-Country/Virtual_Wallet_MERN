const SecurityAndPrivacy = () => {
  return (
    <section className="w-full flex flex-col justify-center items-center text-center my-20">
      <h1 className="font-bold text-3xl bg-white">
        Políticas de Seguridad y Privacidad
      </h1>
      <div className="my-10 w-[70%] text-start bg-twitter p-5">
        <h4 className="font-semibold mt-10 mb-5">
        ...
        <h4 className="font-semibold mt-10 mb-5">Uso de la Información</h4>
        <p>
          ...
          <ul>
            <li>
              1. Personalizar tu experiencia en el sitio web y presentarte
              contenido relevante.
            </li>{' '}
            <br />
            <li>
              2. Proporcionarte soporte técnico y responder a tus consultas.
            </li>{' '}
            <br />
            <li>
              3. Enviar actualizaciones periódicas, boletines informativos y
              comunicaciones promocionales.
            </li>{' '}
            <br />
            <li>
              4. Mejorar nuestros productos y servicios según tus comentarios y
              necesidades.
            </li>{' '}
            <br />
            <li>
              5. Realizar análisis y estudios de mercado para comprender mejor a
        ...
        <p>
          ...
          <ol>
            <li>
              1. Con proveedores de servicios y socios de confianza que nos
            ...
            <br />
            <li>
              2. Cuando sea requerido por ley, cumplir con procesos legales,
              solicitudes gubernamentales aplicables o para proteger nuestros
              derechos legales.
            </li>
          </ol>
        </p>
        <h4 className="font-semibold mt-10 mb-5">Enlaces a Sitios Externos</h4>
        <p>
