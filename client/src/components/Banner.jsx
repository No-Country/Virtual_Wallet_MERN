    ...
    <section className="overflow-hidden w-full h-[400px]">
      <div className="flex w-full h-full">
        <div className="w-1/2 p-3 flex flex-col gap-9 justify-center items-start">
          <h1 className="font-titulo font-bold text-c-botones text-4xl">
        ...
        <div className="w-1/2 p-3 flex items-center justify-start">
          <div className="w-[500px] h-[280px] relative">
            <section
              className="tarjeta1 bg-c-botones flex flex-col justify-around  w-[300px] h-[195px] bg-c-botones-hover rounded-lg border-c-fuente shadow-black shadow-md pl-7"
              style={{ boxShadow: '8px 8px 5px #a1a1a1,-8px -8px 5px #ffffff' }}
            >
            ...
            <section
              className="tarjeta2 absolute right-0 bottom-0 flex flex-col justify-around  w-[300px] h-[195px] bg-c-botones-hover rounded-lg border-c-fuente overflow-hidden"
