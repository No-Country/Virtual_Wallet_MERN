    ...
    <section className="overflow-hidden w-full h-[400px]">
      <div className="flex w-full h-full">
        <div className="w-1/2 p-3 flex flex-col gap-9 justify-center items-start pl-10">
          <h1 className="font-titulo font-bold text-c-titulo text-4xl">Todas tus cuentas en un solo Lugar</h1>
          <p className="font-parrafo text-c-subtitulo text-x">Organiza tus finanzas desde la comodidad de tu hogar!!!</p>
        </div>
        <div className="w-1/2 p-3 flex items-center justify-start">
          <div className="w-[500px] h-[280px] relative">
            ...
            <section className="tarjeta2 absolute right-0 bottom-0 flex flex-col justify-around  w-[300px] h-[170px] bg-c-botones-hover rounded-lg border-2 border-black shadow-black shadow-lmd overflow-hidden">
